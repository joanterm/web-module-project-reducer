      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick={() => handleAddMPlus()}/>
              <CalcButton value={"MR"} onClick={() => handleAddMR()}/>
              <CalcButton value={"MC"} onClick={() => handleAddMC()}/>
            </div>
            ...
            <div className="row">
              ...
              <CalcButton value={9} onClick={() => handleApplyNumber(8)}/>
            </div>
